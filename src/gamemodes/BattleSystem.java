...
public class BattleSystem {
    ...
    public boolean startSingleplayer(Character player, Character ai){
        ...
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC +
                "                                           [ PLAYER VS AI BATTLE ]" +
                Colors.RESET);

        System.out.println(
                Colors.WHITE + Colors.BOLD + Colors.ITALIC +
                        "                                           " + player.getName() +
                        Colors.RESET + " VS " +
                        Colors.WHITE + Colors.BOLD + Colors.ITALIC +
                        ai.getName() +
        ...
        System.out.println(Colors.LIGHT_GREY + "                                           Press Enter to start!" + Colors.RESET);
        scanner.nextLine();
        ...
        while(player.isAlive() && ai.isAlive() && !forceExit){
            ...
            if(player.isAlive()){
                ...
                System.out.print("                                           " + Colors.WHITE + Colors.BOLD + Colors.ITALIC + player.getName() + Colors.RESET + " (You) ");
                player.getStamina().regen();
            }

            if(ai.isAlive()){
                System.out.print("                                           " + Colors.WHITE + Colors.BOLD + Colors.ITALIC + ai.getName() + Colors.RESET + " ");
                ai.getStamina().regen();
            }
    ...
    public Character startMultiplayer(Character player1, Character player2, boolean player1GoesFirst){
        ...
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC +
                "\n                                           [ PLAYER VS PLAYER BATTLE ]" + Colors.RESET);

        System.out.println(
                Colors.WHITE + Colors.BOLD + Colors.ITALIC + "                                           " + player1.getName() + Colors.RESET + " VS " + Colors.WHITE + Colors.BOLD + Colors.ITALIC + player2.getName() + Colors.RESET
        );
        ...
        while(player1.isAlive() && player2.isAlive() && !forceExit){
            if(player1Turn){
                System.out.println(Colors.CYAN + "                                           =====================================" + Colors.RESET);
                System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "                                           PLAYER 1'S TURN (" + player1.getName() + ")" + Colors.RESET);
                System.out.println(Colors.CYAN + "                                           ======================================" + Colors.RESET);

                playerTurn(player1, player2, 2);
            }else{
                System.out.println(Colors.CYAN + "                                           ======================================" + Colors.RESET);
                System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "                                           PLAYER 2'S TURN (" + player2.getName() + ")" + Colors.RESET);
                System.out.println(Colors.CYAN + "                                           ======================================" + Colors.RESET);
            ...
            if(player1.isAlive()){
                System.out.print("                                           " + Colors.WHITE + Colors.BOLD + Colors.ITALIC + player1.getName() + Colors.RESET + " (P1) ");
                player1.getStamina().regen();
            }

            if(player2.isAlive()){
                System.out.print("                                           " + Colors.WHITE + Colors.BOLD + Colors.ITALIC + player2.getName() + Colors.RESET + " (P2) ");
        ...
        if (!forceExit) {
            ...
            if(player1.isAlive()) {
                displayVictory(player1);
            } else {
                displayVictory(player2);
            }
        ...
        switch (action) {
            case 1:
                ...
                if (attacker.getStamina().getCurrent() >= basicCost) {
                    ...
                    System.out.println(Colors.BLUE + "                                           Used " + basicCost + " stamina for " + attacker.getBasic() + Colors.RESET);
            ...
            case 2:
                ...
                if (attacker.getStamina().getCurrent() >= specialCost) {
                    ...
                    System.out.println(Colors.BLUE + "                                           Used " + specialCost + " stamina for " + attacker.getSpecial() + Colors.RESET);
            ...
            case 3:
                ...
                if (attacker.getStamina().getCurrent() >= ultimateCost) {
                    ...
                    System.out.println(Colors.BLUE + "                                          Used " + ultimateCost + " stamina for " + attacker.getUltimate() + Colors.RESET);
                    ...
                    System.out.println(Colors.LIGHT_GREY + "                                           Performing basic attack instead!" + Colors.RESET);
                    ...
                    if (attacker.getStamina().getCurrent() >= basicFallbackCost) {
                        ...
                        System.out.println(Colors.BLUE + "                                           Used " + basicFallbackCost + " stamina for fallback " + attacker.getBasic() + Colors.RESET);
    ...
    private int getValidAction() {
        while (true) {
            ...
            try {
                ...
                System.out.print(Colors.RED + "\n                                           Please enter a valid number [1], [2], [3], or [X] to exit: " + Colors.RESET);
            }
        }
    }
        ...
        switch (action){
            case 1:
                ...
                if(ai.getStamina().getCurrent() >= basicCost){
                    ...
                    System.out.println(Colors.BLUE + "                                           " + ai.getName() + " used " + basicCost + " stamina for " + ai.getBasic() + Colors.RESET);
            ...
            case 2:
                ...
                if(ai.getStamina().getCurrent() >= specialCost){
                    ...
                    System.out.println(Colors.BLUE + "                                           " + ai.getName() + " used " + specialCost + " stamina for " + ai.getSpecial() + Colors.RESET);
            ...
            case 3:
                ...
                if(ai.getStamina().getCurrent() >= ultimateCost){
                    ...
                    System.out.println(Colors.BLUE +"                                            " + ai.getName() + " used " + ultimateCost + " stamina for " + ai.getUltimate() + Colors.RESET);
                    ...
                    if(ai.getStamina().getCurrent() >= basicFallbackCost){
                        ...
                        System.out.println(Colors.BLUE +"                                           " + ai.getName() + " used " + basicFallbackCost + " stamina for fallback " + ai.getBasic() + Colors.RESET);
    ...
    private void displayStats(Character c1, Character c2, int mode) {
        ...
        if (mode == 1) {
            System.out.printf(
                    Colors.CYAN + "                                           %-15s VS %-15s%n" + Colors.RESET,
                    c1.getName() + Colors.GREEN + " (You)" + Colors.RESET, c2.getName() + Colors.RED + " (Enemy)" + Colors.RESET
            );
        } else {
            System.out.printf("                                           %-15s VS %-15s%n",
                    c1.getName() + " (P1)", c2.getName() + " (P2)");
        }
        System.out.println(Colors.BLUE + "                                           --------------------------------------" + Colors.RESET);

        System.out.printf(Colors.GREEN+"                                           HP: %3d/%-3d      |      HP: %3d/%-3d%n",
                c1.getHp(), c1.getMaxHp(),
                c2.getHp(), c2.getMaxHp());

        System.out.printf(Colors.BLUE+"                                           STA: %3d/%-3d       |      STA: %3d/%-3d%n",
    ...
    private void displayBattleIntro(){
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "\n                                           ======================================" + Colors.RESET);
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "                                                     BATTLE START" + Colors.RESET);
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "                                           ======================================" + Colors.RESET);
    }

    //Display battle result - Lou
    private void displayBattleResult(){
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "\n                                           ======================================" + Colors.RESET);
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "                                                    BATTLE FINISHED" + Colors.RESET);
        System.out.println(Colors.CYAN + Colors.BOLD + Colors.ITALIC + "                                           ======================================" + Colors.RESET);
    }

    public void displayVictory(Character winner) {
        ...
        System.out.println(Colors.GREEN + "\n                                                    ✦ ✦ ✦  " + winner.getName().toUpperCase() + " WINS!  ✦ ✦ ✦" + Colors.RESET);
        System.out.println(Colors.MOON_WHITE + "                                                       Remaining HP: " + winner.getHp() + "/" + winner.getMaxHp() + Colors.RESET);
        System.out.println(Colors.GOLD + "                                       ══════════════════════════════════════════════════════" + Colors.RESET);
    }

    public void displayDefeat(Character loser) {
        System.out.println(Colors.RED + "\n\n\n");
        System.out.println("                                           ██████╗ ███████╗███████╗███████╗ █████╗ ████████╗");
        System.out.println("                                           ██╔══██╗██╔════╝██╔════╝██╔════╝██╔══██╗╚══██╔══╝");
        System.out.println("                                           ██║  ██║█████╗  █████╗  █████╗  ███████║   ██║   ");
        ...
        System.out.println("                                           ██████╔╝███████╗██║     ███████╗██║  ██║   ██║   ");
        System.out.println("                                           ╚═════╝ ╚══════╝╚═╝     ╚══════╝╚═╝  ╚═╝   ╚═╝   " + Colors.RESET);
        System.out.println(Colors.MAROON + "\n                                                 ✦ ✦ ✦  " + loser.getName().toUpperCase() + " HAS FALLEN...  ✦ ✦ ✦" + Colors.RESET);
        System.out.println(Colors.MOON_GREY + "                                                       Better luck next time..." + Colors.RESET);
    ...
    private void displaySkills(Character character){
        ...
        System.out.println(Colors.BLUE + "                                           Current Stamina: " + character.getStamina().getCurrent() + "/" + character.getStaminaMax() + Colors.RESET);
        System.out.println(Colors.ITALIC + "                                           [1] " + character.getBasic() + " (Cost: " + character.getBasicAttackStaminaCost() + ")" + Colors.RESET);
        System.out.println(Colors.ITALIC + "                                           [2] " + character.getSpecial() + " (Cost: " + character.getSpecialSkillStaminaCost() + ")" + Colors.RESET);
        System.out.println(Colors.ITALIC + "                                           [3] " + character.getUltimate() + " (Cost: " + character.getUltimateSkillStaminaCost() + ")" + Colors.RESET);
        System.out.println(Colors.LIGHT_GREY + "                                           [X] Exit to Menu" + Colors.RESET);
    }
